...
**Note. According to [this](https://github.com/srsran/srsRAN_Project), srsRAN_Project is now [OCUDU](https://gitlab.com/ocudu/ocudu).**
---
...
**4GB or more memory is required to build. And when srsRAN_Project gNodeB is configured with the ZMQ-based RF driver, 5 CPU cores or more are required to start up and accept connections from UEs. This constraint regarding the minimum number of CPU cores may be unique to my environment.**
